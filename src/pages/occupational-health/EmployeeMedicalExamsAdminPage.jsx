...
import { Card, CardHeader, CardBody, Typography, Select, Option, Alert, Collapse, Button, Spinner } from '@material-tailwind/react';
    ...
    <Card className="mt-8">
      ...
      <CardBody>
        {loadingEmployees ? (
          ...
          <Select label="Selecciona un empleado" value={selectedEmployeeId || ''} onChange={val => setSelectedEmployeeId(val)}>
            {employees.map(emp => (
