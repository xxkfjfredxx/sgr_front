...
import { Typography, Input, Button, Spinner, Card, CardBody, Switch, Select, Option } from '@material-tailwind/react';
...
const educationLevels = ['Básica', 'Media', 'Técnico', 'Tecnólogo', 'Pregrado', 'Posgrado'];
...
export default function EmployeeWizardForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-6">
      <Typography variant="h4">{step === 1 ? 'Información del Empleado' : 'Vínculo Laboral'}</Typography>
      ...
      {step === 1 && (
        <form className="space-y-4">
          ...
          <Select label="Caja de Compensación" value={employee.compensation_fund} onChange={val => setEmployee({ ...employee, compensation_fund: val })} required>
            <Option value="Compensar">Compensar</Option>
            <Option value="Colsubsidio">Colsubsidio</Option>
            <Option value="Cafam">Cafam</Option>
            <Option value="Comfama">Comfama</Option>
            <Option value="Comfenalco Quindío">Comfenalco Quindío</Option>
            ...
            <Option value="Cajamag">Cajamag (Magdalena)</Option>
      ...
      {step === 2 && (
        <Card>
          <CardBody className="space-y-4">
            ...
            <AutocompleteCargo value={link.position} onChange={val => handleLinkChange('position', val)} />

            <Input label="Salario" value={link.salary} onChange={e => handleLinkChange('salary', formatSalary(e.target.value))} />

            <Input label="Fecha de Inicio" type="date" value={link.start_date} onChange={e => handleLinkChange('start_date', e.target.value)} />
